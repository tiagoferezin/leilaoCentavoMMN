 ...
 * 
 */
package leilaoCentavosMMN.control;
	...
	public static void transactionBegin(EntityManager entityManager) {
		...
		if (entityManager != null) {
			...
			if (entityManager.isOpen()) {
				System.out
						.println("  Verificando entityManager.getTransaction().isActive");
	...
	public static void transactionCommit(EntityManager entityManager) {
		...
		if (entityManager != null) {
			...
			if (entityManager.isOpen()) {
				...
				if (entityManager.getTransaction().isActive()) {
					System.out
							.println("  Comitando: entityManager.getTransaction().commit()");
	...
	public static void transactionRollback(EntityManager entityManager) {
		...
		if (entityManager != null) {
			...
			if (entityManager.isOpen()) {
				...
				if (entityManager.getTransaction().isActive()) {
					System.out
							.println("  Desfazendo: entityManager.getTransaction().rollback()");
